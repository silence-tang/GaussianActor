...
class ZJUMOCAPDataset(Dataset):
    ...
    def get_single_item(
        ...
        if self.sample_rays:
            ...
            sampled_uv_all = np.dot(homo_2d.copy().reshape([-1, 3]), K_inv.T)
            sampled_rays_all = self.get_camera_rays(R, sampled_uv_all).reshape(homo_2d.shape)
            ...
            data.update({
                ...
                'sample_ray_dirs_all': sampled_rays_all,
