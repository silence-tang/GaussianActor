...
from datasets_v2 import ZJUMOCAPDataset
...
ZJUMOCAPDataConfig = {
    ...
    "subject00": {
        ...
        "nv_test_end_frame": 1000,

        "np_test_start_frame": 2000,
        "np_test_end_frame": 2200,
        
        "test_sampling_rate": 15,

        "train_cur_views": ['cam01', 'cam07', 'cam13', 'cam19'],
        "test_cur_views": ['cam01', 'cam07', 'cam13', 'cam19'],
        
        "train_views": ['cam00', 'cam01', 'cam02', 'cam03', 'cam04', 'cam05', 'cam06', 'cam07', 'cam08', 'cam09', 'cam10', 'cam11', 'cam12', 'cam13', 'cam14', 'cam15', 'cam16', 'cam17', 'cam18', 'cam19', 'cam20', 'cam21', 'cam22', 'cam23'],
        "val_views": ['cam01', 'cam08', 'cam15', 'cam22'],
        "nv_test_views": ['cam01', 'cam08', 'cam15', 'cam22'],
        "np_test_views": ['cam00', 'cam01', 'cam02', 'cam03', 'cam04', 'cam05', 'cam06', 'cam07', 'cam08', 'cam09', 'cam10', 'cam11', 'cam12', 'cam13', 'cam14', 'cam15', 'cam16', 'cam17', 'cam18', 'cam19', 'cam20', 'cam21', 'cam22', 'cam23'],
    },
    ...
    def setup(self, stage: str):
        if stage == "fit": 
            self.train_dataset = ZJUMOCAPDataset(
                ...
                num_fg_samples = self.num_fg_samples,
                num_bg_samples = self.num_bg_samples,
                sample_views = self.train_sample_views,
                repeat = self.train_dataset_repeat,
                sample_rays = self.sample_rays,
            )
